...
function create(username, password, permisssions) {
    return when.resolve(function (resolve) {
        var user = {
            username: username,
            password: password,
            permissions: util.isArray(permisssions) ? permisssions : [permisssions]
        };
        users[username] = user;
